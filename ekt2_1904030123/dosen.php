...
<div class ="row mt-4"> 
  ...
  <!--menu-->
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="tambah.php"><i class="fas fa-user-edit"></i> INPUT MABA</a><hr>
      </li>
      <li class="nav-item">
  ...
  <!--konten-->
  <h3> <i class="fas fa-users"></i> DAFTAR DOSEN </h3><hr>
  ...
  <?php if (empty($dosen)) :?>
    ...
    <?php foreach ($dosen as $dsn): ?>
        <tr>
          ...
          <td><img src = "foto/<?php echo $dsn ['foto'];?> " width = "100px"></td>
